...
1. 大型搜索、5 个真实任务入口和一行隐私提醒；
2. 4 个常用工具与当前任务的标准路径；
3. 一个核心教学工具、写作与阅读专区、课堂观察专区；
4. 3 条精选提示词和有可靠日期的最近核验。

完整资源不在首页展开。搜索范围覆盖工具名称、别名、说明、场景、标签、补充关键词，以及提示词标题、分类和使用场景。全局搜索按工具与提示词的实际匹配数量进入对应资源库，两类均有结果时优先显示匹配更多的一类；选择任务后回到首页，核心工具、推荐路径、精选提示词和相关专区同步更新。
...
7. “最近核验”需要可靠日期时再填写 `updatedAt`，它表示目录内容最后确认或核对时间，不是外部工具发布日期。
